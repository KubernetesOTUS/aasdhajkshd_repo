...
variable "vm_env" {
    ...
    default = {
        gw = "10.10.160.1"
        dns = ["10.10.51.3", "8.8.8.8"]
        domain = ["lab.auxo.team", "unify.local"]
        cpus = 2
        vmem = 4096
        disk_size = 20
    }
...
variable "vsphere_host" {
  ...
  type        = map(any)
  default     = {
    "esxi-1rzn25j" = "10.10.160.201"
    "esxi-s4clj032" = "10.10.160.202"
    "esxi-s4clj015" = "10.10.160.203"
    "esxi-s4clj111" = "10.10.160.204"
  }
}
